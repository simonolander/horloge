...
object Sounds {
    ...
    private val D_SHARP_1 = Sound("1d1a194f-a67a-46c3-8b5b-79c8bad6a68e", "Guitar, D\u266f 1", R.raw.kyster__low_d_sharp_117719, "Nylon guitar")
    ...
    private val F_SHARP_2 = Sound("1b8c5c4a-450c-4af4-bfa4-225076a89f95", "Guitar, F\u266f 2", R.raw.kyster__1_oct_f_sharp_117690, "Nylon guitar")
    private val G_2 = Sound("e69697a9-ff2b-4b9f-85c2-d45b9f460b2a", "Guitar, G 2", R.raw.kyster__1_oct_g_117693, "Nylon guitar")
    private val G_SHARP_2 = Sound("f8608576-494c-4000-b7ee-153cc6de310f", "Guitar, G\u266f 2", R.raw.kyster__1_oct_g_sharp_117692, "Nylon guitar")
    private val A_2 = Sound("1dda5a68-3453-45ca-befa-ef2c47f74bec", "Guitar, A 2", R.raw.kyster__1_oct_a_117683, "Nylon guitar")
    private val A_SHARP_2 = Sound("cffef2a2-91f9-458d-b187-6ccce76cb36f", "Guitar, A\u266f 2", R.raw.kyster__1_oct_a_sharp_117682, "Nylon guitar")
    ...
    private val C_SHARP_3 = Sound("fc318cee-56ae-4a60-8cf6-9d7cdccd770b", "Guitar, C\u266f 3", R.raw.kyster__1_oct_c_sharp_117685, "Nylon guitar")
    private val D_3 = Sound("df3d7e57-179c-4026-a981-44013782d5ee", "Guitar, D 3", R.raw.kyster__1_oct_d_117688, "Nylon guitar")
    private val D_SHARP_3 = Sound("e7bc6785-5525-4294-8a51-603ed7bd8ed6", "Guitar, D\u266f 3", R.raw.kyster__1_oct_d_sharp_117687, "Nylon guitar")
    ...
    private val F_SHARP_3 = Sound("97326879-e47c-43e8-847d-2a0147f9f120", "Guitar, F\u266f 3", R.raw.kyster__2_oct_f_sharp_117702, "Nylon guitar")
    private val G_3 = Sound("f2f8d254-1b39-4a6c-a060-66fd4dbbc7a7", "Guitar, G 3", R.raw.kyster__2_oct_g_117705, "Nylon guitar")
    private val G_SHARP_3 = Sound("3299695f-b341-422e-849d-c760fa3f50a0", "Guitar, G\u266f 3", R.raw.kyster__2_oct_g_sharp_117704, "Nylon guitar")
    private val A_3 = Sound("189a86b4-097c-4e15-bda2-2c2790ddffbd", "Guitar, A 3", R.raw.kyster__2_oct_a_117695, "Nylon guitar")
    private val A_SHARP_3 = Sound("7cbce269-1e68-4c03-b424-78bf0724fda1", "Guitar, A\u266f 3", R.raw.kyster__2_oct_a_sharp_117694, "Nylon guitar")
    ...
    private val D_SHARP_4 = Sound("a14ab7c1-b8d4-4604-95cf-d8b3cfe35491", "Guitar, D\u266f 4", R.raw.kyster__2_oct_d_sharp_117699, "Nylon guitar")
    ...
    private val BRONZE_BELL_1 = Sound("0f68242e-9866-4886-99ea-5554e824405e", "Bronze bell 1", R.raw.benboncan__bronze_bell_1, "Bells and gongs")
    private val BRONZE_BELL_2 = Sound("1a84778c-74b2-4c20-a6b8-79e492923f73", "Bronze bell 2", R.raw.benboncan__bronze_bell_2, "Bells and gongs")
    private val BRONZE_BELL_3 = Sound("b4600654-4f77-43d8-90c2-aa20dc2b68fa", "Bronze bell 3", R.raw.benboncan__bronze_bell_3, "Bells and gongs")
    ...
    private val GLASS_LID_REVISITED = Sound("62af64a7-d14f-4a91-bafa-44e54143d8b3", "Glass lid revisited", R.raw.benboncan__glass_lid_revisited, "Bells and gongs")
    private val LARGE_CYMBAL_FELT = Sound("65c90b43-4cc2-4abf-a538-7187b05ee08b", "Large cymbal felt", R.raw.benboncan__large_cymbal_felt, "Bells and gongs")
    private val LARGE_CYMBAL_STICK = Sound("574f95ca-cd7d-470f-91c6-e3389cec78ac", "Large cymbal stick", R.raw.benboncan__large_cymbal_stick, "Bells and gongs")
    private val STAINLESS_STEEL_BOWL = Sound("70d9cce7-630f-4421-8de7-b6927aa6c15b", "Stainless steel bowl", R.raw.benboncan__stainless_steel_bowl, "Bells and gongs")
    private val STAINLESS_STEEL_BOWL_1 = Sound("3cda6f26-52a1-496b-9bf8-22d0a3b33fcb", "Stainless steel bowl 1", R.raw.benboncan__stainless_steel_bowl_1, "Bells and gongs")
    private val STAINLESS_STEEL_BOWL_2 = Sound("5b18da27-5743-43ca-992c-b240e17106b9", "Stainless steel bowl 2", R.raw.benboncan__stainless_steel_bowl_2, "Bells and gongs")
    private val STAINLESS_STEEL_BOWL_3 = Sound("141dab9c-9d8b-40ed-915b-dfdacfc21190", "Stainless steel bowl 3", R.raw.benboncan__stainless_steel_bowl_3, "Bells and gongs")
    private val STAINLESS_STEEL_BOWL_4 = Sound("177153eb-e1fe-479c-b0d8-858213f46fe4", "Stainless steel bowl 4", R.raw.benboncan__stainless_steel_bowl_4, "Bells and gongs")
    private val STAINLESS_STEEL_LID_1 = Sound("ef683ea4-9244-485d-88bf-b97ee7aafe56", "Stainless steel lid 1", R.raw.benboncan__stainless_steel_lid_1, "Bells and gongs")
    private val STAINLESS_STEEL_LID_2 = Sound("5b67fd12-2acd-4519-a5d0-3f5618eaa3dd", "Stainless steel lid 2", R.raw.benboncan__stainless_steel_lid_2, "Bells and gongs")
    ...
    operator fun get(id: String): Sound? {
